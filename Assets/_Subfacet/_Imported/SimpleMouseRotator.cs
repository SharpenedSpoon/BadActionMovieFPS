...
public class SimpleMouseRotator : MonoBehaviour {
	...
	public bool invertMouseY = true; // PEOPLE WHO DON'T USE THIS ARE LAME!
	private int invertY = 1;

	void Awake() {
		invertY = (invertMouseY ? -1 : 1);
	}
	...
	void Update () {
		...
		if (relative)
		{
			...
			inputV = invertY * CrossPlatformInput.GetAxis("Mouse Y");
